...
int main()
{
    ...
    //Otetaan sensoriarvot talteen kalibrointia varten
    ...
    for(;;)
    {
        ...
        {   
            ...
            //Suoraan
            if (vasenSensori < 0.14 && oikeaSensori < 0.14) {
                left = 255;
                right = 80;
            }
            ...
            //Ulosajo ja takaisin kääntyminen
                ...
                motor_sharpTurn(240,100,230,sharpTurnDirection);
                int leftTemp = right;
                left = right;
                right = leftTemp;  
